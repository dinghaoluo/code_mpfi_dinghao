...
#
# It is designed to test whether one internally consistent LC-DA-CA1 architecture can reproduce the main qualitative and semi-quantitative findings across the three experiment classes while remaining simple enough to explain clearly.
