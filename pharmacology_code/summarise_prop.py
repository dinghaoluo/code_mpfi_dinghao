...
import rec_list
pathNEblocker = rec_list.pathNEblocker
sessNEblocker = rec_list.sessNEblocker
...
for i, pathname in enumerate(pathNEblocker):    
    ...
    for sess in sesslist:
        ...
        run_dist_file = sio.loadmat(pathname+'\\'+recname+'\\'+f'{recname}_runSpeedDist_Run1.mat')
        ...
        lick_dist_file = sio.loadmat(pathname+'\\'+recname+'\\'+f'{recname}_lickDist.mat')
