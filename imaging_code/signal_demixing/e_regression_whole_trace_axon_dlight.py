...
#%% single-block regression using full red trace
block_to_analyze = (20, 15)
grid_size = 16
pre = 90
post = 120

final_corrected_green_trace, original_axon_green_trace, estimated_full_artifact, smooth_red_trace = rrfg.correct_green_trace_with_red(
    mov=mov,
    movr=movr,
...
rrfg.plot_correction_validation_suite(
...
# red-channel control (apply same method where “green” == red)
final_corrected_red_trace, original_axon_red_trace, estimated_full_artifact_red, smooth_red_trace1 = rrfg.correct_green_trace_with_red(
    mov=movr,
    movr=movr,
    global_mask_green=dilated_global_axon_dlight_mask,
    global_mask_red=dilated_global_axon_dlight_mask,
...
rrfg.plot_correction_validation_suite(
    original_axon_red_trace,
    estimated_full_artifact_red,
    final_corrected_red_trace,
    smooth_red_trace1,
    reward_frames,
    block_to_analyze,
    pre_frames=pre,
...
rrfg.run_regression_pipeline(
    mov=mov,
    movr=movr,
    global_mask_green=dilated_global_axon_dlight_mask,   # green mask
    global_mask_red=dilated_global_axon_dlight_mask,     # red mask
