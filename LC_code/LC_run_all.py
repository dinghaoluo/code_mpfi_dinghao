...
import LC_all_waveforms_acgs, LC_all_extract, LC_all_identity_UMAP, LC_all_profiles


#%% pipeline proper 

'''
1) get the waveforms, acgs and tagged vs non-tagged (identities) of recorded 
...
'''
2) extract spike rasters (spike maps, 0's and 1's) and spike trains (smoothed)
...
'''
3) apply UMAP-k-means clustering onto spike ACGs of recorded units, and then 
...
'''
4) finally, summarise unit properties and place them into a pandas dataframe 
