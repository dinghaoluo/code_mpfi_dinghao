...
for cluname in clu_list:
    ...
    def rew_to_run_helper(x):
        return starts[x] - pumps[x-1][0]
    temp_ordered = sorted(trial_list, key=rew_to_run_helper)
    ...
    if noStim=='Y' or noStim=='y':
        if cluname in tag_list:
            fig.savefig('Z:\Dinghao\code_dinghao\LC_all\single_cell_raster_by_rew2run_noStim\{}_tagged.png'.format(cluname),
                        dpi=300,
                        bbox_inches='tight')
            fig.savefig('Z:\Dinghao\code_dinghao\LC_all\single_cell_raster_by_rew2run_noStim\{}_tagged.pdf'.format(cluname),
                        bbox_inches='tight')
        elif cluname in put_list:
            fig.savefig('Z:\Dinghao\code_dinghao\LC_all\single_cell_raster_by_rew2run_noStim\{}_putative.png'.format(cluname),
                        dpi=300,
                        bbox_inches='tight')
            fig.savefig('Z:\Dinghao\code_dinghao\LC_all\single_cell_raster_by_rew2run_noStim\{}_putative.pdf'.format(cluname),
                        bbox_inches='tight')
        else:
            fig.savefig('Z:\Dinghao\code_dinghao\LC_all\single_cell_raster_by_rew2run_noStim\{}.png'.format(cluname),
                        dpi=300,
                        bbox_inches='tight')
            fig.savefig('Z:\Dinghao\code_dinghao\LC_all\single_cell_raster_by_rew2run_noStim\{}.pdf'.format(cluname),
                        bbox_inches='tight')
    else:
        if cluname in tag_list:
            fig.savefig('Z:\Dinghao\code_dinghao\LC_all\single_cell_raster_by_rew2run\{}_tagged.png'.format(cluname),
                        dpi=300,
                        bbox_inches='tight')
            fig.savefig('Z:\Dinghao\code_dinghao\LC_all\single_cell_raster_by_rew2run\{}_tagged.pdf'.format(cluname),
                        bbox_inches='tight')
        elif cluname in put_list:
            fig.savefig('Z:\Dinghao\code_dinghao\LC_all\single_cell_raster_by_rew2run\{}_putative.png'.format(cluname),
                        dpi=300,
                        bbox_inches='tight')
            fig.savefig('Z:\Dinghao\code_dinghao\LC_all\single_cell_raster_by_rew2run\{}_putative.pdf'.format(cluname),
                        bbox_inches='tight')
        else:
            fig.savefig('Z:\Dinghao\code_dinghao\LC_all\single_cell_raster_by_rew2run\{}.png'.format(cluname),
                        dpi=300,
                        bbox_inches='tight')
            fig.savefig('Z:\Dinghao\code_dinghao\LC_all\single_cell_raster_by_rew2run\{}.pdf'.format(cluname),
                        bbox_inches='tight')
