...
for pathname in pathHPC:
    ...
    for i in range(tot_clu):
        if int_id[i]==True:
            ...
            outdir = '{}\stim_ctrl_int_only'.format(outdirroot)
...
#%% save dataframe 
df.to_csv(r'Z:\Dinghao\code_dinghao\HPC_all\HPC_LC_stim_ctrl_diff_profiles_int_only.csv')
df.to_pickle(r'Z:\Dinghao\code_dinghao\HPC_all\HPC_LC_stim_ctrl_diff_profiles_int_only.pkl')
