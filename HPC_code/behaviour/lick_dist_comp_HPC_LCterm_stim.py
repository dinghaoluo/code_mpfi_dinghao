...
import rec_list
pathOpt = rec_list.pathHPCLCtermopt_beh
...
for sessname in sess_list:
    ...
    if comp_method == 'baseline':
        fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_lickdist_0{}0_HPC_LCterm_stim\{}.png'.format(stim_cond, sessname),
                    dpi=300,
                    bbox_inches='tight')
    elif comp_method == 'stim_cont':
        fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_lickdist_0{}0_stim_cont_HPC_LCterm_stim\{}.png'.format(stim_cond, sessname),
                    dpi=300,
                    bbox_inches='tight')
...
if comp_method == 'baseline':
    fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_lickdist_020_HPC_LCterm_stim\summary_wilc.png',
                dpi=500,
                bbox_inches='tight')
elif comp_method == 'stim_cont':
    fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_lickdist_020_stim_cont_HPC_LCterm_stim\summary_wilc.png',
                dpi=500,
                bbox_inches='tight')