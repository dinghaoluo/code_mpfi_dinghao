...
import rec_list
pathOpt = rec_list.pathHPCLCtermopt
...
for sessname in sess_list:
    ...
    if comp_method == 'baseline':
        fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_licktime_0{}0_HPC_LCterm_stim\{}.png'.format(stim_cond, sessname),
                    dpi=300,
                    bbox_inches='tight')
    elif comp_method == 'stim_cont':
        fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_licktime_0{}0_stim_cont_HPC_LCterm_stim\{}.png'.format(stim_cond, sessname),
                    dpi=300,
                    bbox_inches='tight')
    ...
    if comp_method == 'baseline':
        fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_licktime_0{}0_HPC_LCterm_stim\{}_control_velocity.png'.format(stim_cond, sessname),
                    dpi=300,
                    bbox_inches='tight')
    elif comp_method == 'stim_cont':
        fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_licktime_0{}0_stim_cont_HPC_LCterm_stim\{}_control_velocity.png'.format(stim_cond, sessname),
                    dpi=300,
                    bbox_inches='tight')
    ...
    if comp_method == 'baseline':
        fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_licktime_0{}0_HPC_LCterm_stim\{}_control_peak_velocity.png'.format(stim_cond, sessname),
                    dpi=300,
                    bbox_inches='tight')
    elif comp_method == 'stim_cont':
        fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_licktime_0{}0_stim_cont_HPC_LCterm_stim\{}_control_peak_velocity.png'.format(stim_cond, sessname),
                    dpi=300,
                    bbox_inches='tight')
    ...
    if comp_method == 'baseline':
        fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_licktime_0{}0_HPC_LCterm_stim\{}_control_init_accel.png'.format(stim_cond, sessname),
                    dpi=300,
                    bbox_inches='tight')
    elif comp_method == 'stim_cont':
        fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_licktime_0{}0_stim_cont_HPC_LCterm_stim\{}_control_init_accel.png'.format(stim_cond, sessname),
                    dpi=300,
                    bbox_inches='tight')
...
if comp_method == 'baseline':
    fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_licktime_020_HPC_LCterm_stim\summary_wilc.png',
                dpi=500,
                bbox_inches='tight')
elif comp_method == 'stim_cont':
    fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_licktime_020_stim_cont_HPC_LCterm_stim\summary_wilc.png',
                dpi=500,
                bbox_inches='tight')
...
if comp_method == 'baseline':
    fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_licktime_020_HPC_LCterm_stim\summary_wilc_control_velocity.png',
                dpi=500,
                bbox_inches='tight')
elif comp_method == 'stim_cont':
    fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_licktime_020_stim_cont_HPC_LCterm_stim\summary_wilc_control_velocity.png',
                dpi=500,
                bbox_inches='tight')
...
if comp_method == 'baseline':
    fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_licktime_020_HPC_LCterm_stim\summary_wilc_control_peak_velocity.png',
                dpi=500,
                bbox_inches='tight')
elif comp_method == 'stim_cont':
    fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_licktime_020_stim_cont_HPC_LCterm_stim\summary_wilc_control_peak_velocity.png',
                dpi=500,
                bbox_inches='tight')
...
if comp_method == 'baseline':
    fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_licktime_020_HPC_LCterm_stim\summary_wilc_control_init_accel.png',
                dpi=500,
                bbox_inches='tight')
elif comp_method == 'stim_cont':
    fig.savefig('Z:\Dinghao\code_dinghao\HPC_opto_ephys\opto_licktime_020_stim_cont_HPC_LCterm_stim\summary_wilc_control_init_accel.png',
                dpi=500,
                bbox_inches='tight')
