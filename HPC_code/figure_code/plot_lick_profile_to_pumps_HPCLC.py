...
#%% load behav data 
behaviour = pd.read_pickle('Z:/Dinghao/code_dinghao/behaviour/all_HPCLC_sessions.pkl')
...
plt.show()
for ext in ['png', 'pdf']:
    fig.savefig(r'Z:\Dinghao\code_dinghao\behaviour\lick_to_pumps_HPCLC.{}'.format(ext),
                dpi=300,
                bbox_inches='tight')